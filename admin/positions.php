		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					...
					<input class="input100" type="text" name="position"  placeholder="Enter Position">
						
					<div class="container-login100-form-btn">
						<input type="submit" class="login100-form-btn" name="Submit" value="Add" />
					</div>
					<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="admin.php"><font color=green size="4">Home</a> 
					&nbsp&nbsp&nbsp&nbsp<a href="viewpos.php"><font color=green size="4">View Positions</a> <br>
