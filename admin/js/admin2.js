...
if (candidateForm.classe.value=="")
{
	errorMessage+="please enter the candidate class!\n";
	validationVerified=false;
}
if(candidateForm.image.value==" ")
{
	errorMessage+="please select candidate Image"\n";
	validationVerified=false;
}
if (!isValidimage(candidateForm.images.value)) {
errorMessage+="Invalid image formate!\n";
validationVerified=false;
}
if(!validationVerified)
{
