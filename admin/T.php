			...
			<div class="wrap-login100">
				...
				<form name="form1" class="login100-form validate-form"  method="post" action="checklogin.php" onsubmit="return loginValidate(this)">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="email" id="myusername" placeholder="Email">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="password" name="pass" id="mypassword" placeholder="Password">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
