		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt> <br></br>
					<img src="Login_v1/images/img-ipp.png" alt="IMG">
				</div>
...
?>				
				<br>
				<center><font color=red size=5>Looks like you're trying to log in from an unauthorized device</font></center><br><br><br>
					<center>Return to <a href="index.php"><font color =green size=4>Login</center></a>
